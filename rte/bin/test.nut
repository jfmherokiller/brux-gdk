...
//Misc
local brxQuit = false
::fntW <- newFont(newSprite("cp437w.png", 8, 8, 0, 0, 0, 0), 0, 0, false 0)
::fntR <- newFont(newSprite("cp437r.png", 8, 8, 0, 0, 0, 0), 0, 0, false 0)
::fntG <- newFont(newSprite("cp437g.png", 8, 8, 0, 0, 0, 0), 0, 0, false 0)
::fntB <- newFont(newSprite("cp437b.png", 8, 8, 0, 0, 0, 0), 0, 0, false 0)
::fntE <- newFont(newSprite("cp437e.png", 8, 8, 0, 0, 0, 0), 0, 0, false 0)
